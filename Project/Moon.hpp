...
class Moon {
public:
    Moon(glm::vec3 initialPosition, long long rotationPeriod, glm::vec3 rotationAxis, long long orbitPeriod, glm::vec3 orbitAxis, Earth *earth, float radius, std::string filename, gps::Shader *shader);
...
private:
    ...
    float computeOrbitAngle(long long currentSeconds);
};
