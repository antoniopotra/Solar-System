...
class Earth {
public:
    Earth(glm::vec3 initialPosition, long long rotationPeriod, glm::vec3 rotationAxis, long long orbitPeriod, glm::vec3 orbitAxis, float radius, std::string filename, gps::Shader *shader);
